<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta eliminato il tuo account, tutte le risorse e i dati ad esso associati saranno cancellati in modo permanente. Prima di eliminare il tuo account, ti preghiamo di scaricare tutti i dati o le informazioni che desideri conservare.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta eliminato il tuo account, tutte le sue risorse e dati saranno cancellati in modo permanente. Inserisci la tua password per confermare che desideri eliminare definitivamente il tuo account.') }}
                    </p>
                </div>
