...
<div class="container px-5 my-5" >
    ...
    <form action="{{ route('admin.restaurants.update', $restaurant) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-5 form-check" >
            ...
            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{old('name') ?? $restaurant->name}}">
            @error('name')
        ...
        <div class="my-5 form-check" >
            ...
            <input class="form-control @error('address') is-invalid @enderror" type="text" id="address" name="address" value="{{old('address') ?? $restaurant->address}}">
            @error('address')
            <div class="invalid-feedback">
                <em> {{$message}} </em>
            </div>
        ...
        <div class="my-5 form-check" >
            ...
            <input class="form-control @error('postal_code') is-invalid @enderror" type="number" id="postal_code" name="postal_code" value="{{old('postal_code') ?? $restaurant->postal_code}}">
            @error('postal_code')
            <div class="invalid-feedback">
                <em> {{$message}} </em>
            </div>
        ...
        <div class="my-5 form-check" >
            ...
            <input class="form-control @error('vat_number') is-invalid @enderror" type="text" id="vat_number" name="vat_number" value="{{old('vat_number') ?? $restaurant->vat_number}}">
            @error('vat_number')
            <div class="invalid-feedback">
                <em> {{$message}} </em>
            </div>
