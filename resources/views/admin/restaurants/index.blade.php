...
@section('content')
    <div class="container-fluid p-5 mb-5 bg-dark rounded-3 text-center ">
        ...
        @else
        <h2 class="my-5 d-none d-lg-block"><i class="fa-solid fa-circle-arrow-left"></i>Usa il pulsante sulla sinistra 'Crea il tuo ristorante' per iniziare</h2>
        <h2 class="my-5 d-lg-none"><i class="fa-solid fa-circle-arrow-up"></i>Usa il pulsante in alto 'Crea il tuo ristorante' per iniziare</h2>
        @endif
